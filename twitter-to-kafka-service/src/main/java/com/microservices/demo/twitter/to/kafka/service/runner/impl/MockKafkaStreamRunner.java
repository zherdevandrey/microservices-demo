...
public class MockKafkaStreamRunner implements StreamRunner {
    ...
    private static final String TWITTER_STATUS_DATE_FORMAT = "E MMM dd HH:mm:ss z yyyy";
    ...
    private String getFormattedTweet(String[] keywords, int minTweetLength, int maxTweetLength) {
        String[] params = new String[]{
                ZonedDateTime.now().format(DateTimeFormatter.ofPattern(TWITTER_STATUS_DATE_FORMAT).localizedBy(Locale.US)),
